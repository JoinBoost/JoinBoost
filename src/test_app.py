...
class TestApp(unittest.TestCase):
    def test_predict_api_full_join(self):
        ...
        reg = GradientBoosting(
            learning_rate=1, num_leaves=2**depth, max_depth=depth, n_estimators=iteration
        )
    ...
    def test_predict_api_joingraph(self):
        ...
        reg = GradientBoosting(learning_rate=1, num_leaves=2 ** depth, max_depth=depth, n_estimators=iteration)
